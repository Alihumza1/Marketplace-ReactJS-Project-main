                ...
                <div className='container'>
                    ...
                    <Form onSubmit={this.onSubmitHandler}>
                        ...
                        <Form.Row>
                            ...
                            <Form.Group as={Col} controlId="formGridCategory">
                                ...
                                <Form.Control as="select" defaultValue="Choose..." name="category" required onChange={this.onChangeHandler}>
                                    <option>Choose Service Catogory</option>
                                    
                                    <option value={'properties'}>Car</option>
                                    <option value={'auto'} >MotorBike</option>
                        ...
                        {this.state.loading ?
                            ...
                            :
                            <Button className="col-lg-12" variant="dark" type="submit">Add Service</Button>
                        }
                    </Form>
                </div>
            </>
